...
insert into bitcoin_db.client (email, merchantid, merchant_password, pc_client_id, name)
 	values ('test@gmail.com',"SehSoEF/hE4zQQBTlPHdjQ==","dBPBssVtjCN9Pu9jcocH5w==", 1,"Pero Peric");
-- merchantid2, merchantpass2
 insert into bitcoin_db.client (email, merchantid, merchant_password, pc_client_id, name)
 	values ('test2@gmail.com',"QMx0twcwUPRp4SiSuYDzyQ==","6pxDjNgvUR7Od4c5eoPGtw==", 3, "Zika Zikic");
