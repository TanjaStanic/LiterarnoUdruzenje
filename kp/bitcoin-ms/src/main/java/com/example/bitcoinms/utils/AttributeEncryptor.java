package com.example.bitcoinms.utils;
...
import com.example.bitcoinms.BitcoinMsApplication;
...
public class AttributeEncryptor implements AttributeConverter<String, String> {
    ...
    public String convertToDatabaseColumn(String attribute) {
        ...
        KeyStore keystore;
        InputStream inputStream = BitcoinMsApplication.class.getResourceAsStream("/database.jceks");
