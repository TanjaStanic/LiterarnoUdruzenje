package com.example.paypalms.utils;

import com.example.paypalms.PaypalMsApplication;
...
public class AttributeEncryptor implements AttributeConverter<String, String> {
    ...
    public String convertToDatabaseColumn(String attribute) {
        ...
        KeyStore keystore;
        InputStream inputStream = PaypalMsApplication.class.getResourceAsStream("/database.jceks");
